<div class="sf_admin_list">
  ...
  <?php else: ?>
    <table cellspacing="0">
        ...
        <tr>
          <th colspan="8">
            <?php if ($pager->haveToPaginate()): ?>
              <?php include_partial('lista/pagination', array('pager' => $pager)) ?>
            <?php endif; ?>
      ...
      <tbody>
        <?php foreach ($pager->getResults() as $i => $Lista): $odd = fmod(++$i, 2) ? 'odd' : 'even' ?>
          <tr class="sf_admin_row <?php echo $odd ?>">
            <?php include_partial('lista/list_td_tabular', array('Lista' => $Lista)) ?>
          </tr>
        <?php endforeach; ?>
      </tbody>
    </table>
