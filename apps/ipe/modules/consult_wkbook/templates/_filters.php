...
<div class="sf_admin_filter">
  ...
  <form action="<?php echo url_for('wk_book_consult_wkbook_collection', array('action' => 'filter')) ?>" method="post">
    <table cellspacing="0">
      <tbody>
                        <?php $first = true ?>
                <?php $action = true ?>
                ...
                <?php const WIDGET_PER_ROW = 4 ?>
                <?php const MODEL = "book" ?>
                    ...
                    <?php else: ?>
                        ...
                        <?php if (($widgets_total <= 1) && $action): ?>
                                <td rowspan="<?php echo ceil(count($configuration->getFormFilterFields($form)) / WIDGET_PER_ROW) ?>" style="border:1px solid #DDD;vertical-align:bottom;text-align:right;">
                                    ...
                                    <?php echo link_to(__('Reset', array(), 'sf_admin'), 'wk_book_consult_wkbook_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post')) ?>
