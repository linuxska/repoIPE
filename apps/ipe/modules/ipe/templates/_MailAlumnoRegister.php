...
<p>Sus datos de acceso son:<br />
    <dl>
        <dt>Usuario</dt>
        <dd><?php echo $persona->getNoControl() ?></dd>
        <dt>Contraseña</dt>
...
<p>Si tiene alguna duda en lo relativo al procedimiento del Instituto Práctico Ebenezer puede contactar con <a href='mailto:<?php echo sfConfig::get('app_sf_guard_extra_plugin_mail_from') ?>' style='color:inherit;text-decoration:none;border-bottom:1px grey dotted;'><?php echo sfConfig::get('app_sf_guard_extra_plugin_name_from') ?></a>.</p>
