...
?>
    ...
    <li class="menu_role">
            <ul class="menu_sub">
                ...
                <li class="app <?php echo in_array('libro_consulta_libro', explode('/', $sf_request->getUri())) ? "selected" : "" ?>"><a href="<?php echo url_for('@libro_consulta_libro') ?>" class="alternate">Catalogo de libros IPE</a></li>
            </ul>
    </li>