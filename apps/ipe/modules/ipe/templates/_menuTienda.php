...
?>
    ...
    <li class="menu_role">
            <ul class="menu_sub">
                ...
                <li class="app <?php echo in_array('empleado_tienda', explode('/', $sf_request->getUri())) ? "selected" : "" ?>"><a href="<?php echo url_for('@empleado_tienda') ?>" class="alternate">Catalogo de empleados</a></li>
                <li class="app <?php echo in_array('producto_tienda', explode('/', $sf_request->getUri())) ? "selected" : "" ?>"><a href="<?php echo url_for('@producto_tienda') ?>" class="alternate">Catalogo de productos</a></li>
