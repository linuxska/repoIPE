<?php
/*
 * Menú de acciones para el actor Director del IPE.
 *
...
?>
    ...
    <li class="menu_role">
            <ul class="menu_sub">
                ...
                <li class="app <?php echo in_array('libro', explode('/', $sf_request->getUri())) ? "selected" : "" ?>"><a href="<?php echo url_for('@libro') ?>" class="alternate">Catalogo de libros Ebenezer</a></li>
            </ul>
    </li>
