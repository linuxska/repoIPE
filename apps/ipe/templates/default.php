...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
  <head>
    ...
    <?php include_metas() ?>
    <title><?php include_slot('title', 'ITC :: DGTYV :: CI')?></title>
  ...
  <body>
      ...
      <div class="rp_admin_footer">
        ...
        <p class="rp_admin_ibf">Dr. Noriega No. 161 esq con Ramirez, Colonia Centro, Hermosillo, Sonora. CP 83000.<br />Telefono: 01 662 213 3878 | CorreoE: institutoebenezer@prodigy.ney</p>
