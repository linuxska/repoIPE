...
class IntegerForm extends BaseIntegerForm
{
  public function configure()
  {
  	...
  	$this->widgetSchema->setHelps(array(
  		    'number' => 'Format a 3 digit number with no spaces ###',
            'name' => 'Name of the Dewey',
            ));

    $this->setValidator('number', new sfValidatorRegex(array('pattern' => '/^[0-9]{3}+$/', 'required' => true), array('required' => 'Requerido.', 'invalid' => 'Inválido. El valor debe ser de 3 dígitos.')));
