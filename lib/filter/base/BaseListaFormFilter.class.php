...
abstract class BaseListaFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'primera_calificacion_examen' => new sfValidatorPass(array('required' => false)),
      'calificacion_parcial'        => new sfValidatorPass(array('required' => false)),
      'segunda_calificacion_examen' => new sfValidatorPass(array('required' => false)),
  ...
  public function getFields()
  {
    return array(
      ...
      'primera_calificacion_examen' => 'Text',
      'calificacion_parcial'        => 'Text',
      'segunda_calificacion_examen' => 'Text',
