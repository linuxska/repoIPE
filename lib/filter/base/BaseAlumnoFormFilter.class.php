...
abstract class BaseAlumnoFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'recomendacion_pastor'       => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'preparatoria_pastor'        => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'carta_recomedacion_hermano' => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'certificado_medico'         => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'acta_nacimiento'            => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'fotografias'                => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'acta_matrimonio'            => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ));
    ...
    $this->setValidators(array(
      ...
      'recomendacion_pastor'       => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'preparatoria_pastor'        => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'carta_recomedacion_hermano' => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'certificado_medico'         => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'acta_nacimiento'            => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'fotografias'                => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'acta_matrimonio'            => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
    ));
